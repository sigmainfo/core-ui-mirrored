...
describe 'Coreon.Lib.Select', ->
  ...
  describe 'constructor()', ->
    ...
    describe 'with stubbed Coreon.Lib.Select::.render', ->

      beforeEach ->
        @stub Coreon.Lib.Select::, 'render', ->
          'rendered'

      it 'calls render', ->
        subject = new Coreon.Lib.Select @select
        expect( Coreon.Lib.Select::.render ).to.be.called
  ...
  describe 'showDropdown', ->
    ...
    beforeEach ->
      ...
      @stub Coreon.Lib, 'SelectPopup', => @popup
