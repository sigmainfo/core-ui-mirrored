Feature: User browses concepts of search result
  ...
  Scenario: concept result list
    ...
    And each of them should have a section "DEFINITION"
    And it is "Mechanics that describe behavior of projectiles" for "ballistics"
    And it should be empty for "ball" and "balloon"
