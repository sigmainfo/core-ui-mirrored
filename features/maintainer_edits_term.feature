Feature: maintainer edits term
  ...
  Scenario: removing existing properties
    ...
    When I click "Remove property" within property inputs
  ...
  Scenario: validation errors
    ...
    And this summary should contain "1 error on language"
    ...
    But I should see a message 'Successfully saved term "high hat".'
  ...
  Scenario: reset and cancel
    ...
    And I fill in "Value" with "pending" within property inputs
    When I click "Reset"
    Then I should see "ten-gallon hat" for "Value"
