class Spinach::Features::UserBrowsesRepositoryRootPage < Spinach::FeatureSteps
  ...
  step 'I am manager of a repository "The Art of War", "Ancient Chinese military treatise"' do
    ...
    @repository_user.update_attributes roles: ["user", "manager"], user_name: "xxx"
    current_repository.update_attributes name: "The Art of War", description: "Ancient Chinese military treatise"
  end

  step 'this repository has the copyright string "(c) 512 BC SunTzu"' do
    current_repository.update_attributes copyright: "(c) 512 BC SunTzu"
  end

  step 'it\'s info text reads "Verses from the book occur in modern daily Chinese idioms and phrases."' do
    current_repository.update_attributes info: "Verses from the book occur in modern daily Chinese idioms and phrases."
  end
